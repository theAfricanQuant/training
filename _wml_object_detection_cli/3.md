...
To create a Watson Machine Learning instance, navigate back to your [IBM Cloud Dashboard](ibm.biz/cloud-annotations-sign-up) and click the **Create resource** button.
